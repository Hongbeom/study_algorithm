## SW Academy 5656 - [벽돌 깨기](https://swexpertacademy.com/main/code/problem/problemDetail.do?contestProbId=AWXRQm6qfL0DFAUo&categoryId=AWXRQm6qfL0DFAUo&categoryType=CODE)

### 풀이법

1. DFS를 이용하여 w ^ n 개의 경우를 생성.
2. 경우마다 벽돌을 제거하여 최소 벽돌 갯수 구한다.
