## SW Academy 2383 - [점심 식사시간](https://swexpertacademy.com/main/code/problem/problemDetail.do?contestProbId=AV5-BEE6AK0DFAVl)

### 풀이법

1. 각 사람들이 계단을 택하는 경우의 수를 다 확인하면 되는 문제.
  - 시뮬레이션시 계단입구에 도착 후 1분 후 내려갈수 있음에 주의.
